defmodule Raxx.RequestTest do
  ...
  test "authority should be set from url if provided" do
    assert "myhost.com" == get("//myhost.com/").authority
    assert "myhost.com:1234" == get("//myhost.com:1234/").authority
    assert nil == get("/").authority
  end
